...
class points{
  ...
  maxwell3(){
    let DyE = 0;
    if(this.pos[0]==0){ DyE = (field[this.pos[0]+1][this.pos[1]].E - 0)/2; }
    else if(this.pos[0]==gridsize-1){ DyE = (0 - field[this.pos[0]-1][this.pos[1]].E)/2; }
    else { DyE = (field[this.pos[0]+1][this.pos[1]].E - field[this.pos[0]-1][this.pos[1]].E)/2; }
    
    let DzE = 0;
    if(this.pos[1]==0){ (DzE = field[this.pos[0]][this.pos[1]+1].E - 0)/2; }
    else if(this.pos[1]==gridsize-1){ (DzE = 0 - field[this.pos[0]][this.pos[1]-1].E)/2; }
    else { DzE = (field[this.pos[0]][this.pos[1]+1].E - field[this.pos[0]][this.pos[1]-1].E)/2; }
  ...
  maxwell4(){
    let DyBz = 0;	
    if(this.pos[0]==0){ DyBz = (field[this.pos[0]+1][this.pos[1]].Bz - 0)/2; }
    else if(this.pos[0]==gridsize-1){ DyBz = (0 - field[this.pos[0]-1][this.pos[1]].Bz)/2; }
    else { DyBz = (field[this.pos[0]+1][this.pos[1]].Bz - field[this.pos[0]-1][this.pos[1]].Bz)/2; }
    
    let DzBy = 0;
    if(this.pos[1]==0){ DzBy = (field[this.pos[0]][this.pos[1]+1].By - 0)/2; }
    else if(this.pos[1]==gridsize-1){ DzBy = (0 - field[this.pos[0]][this.pos[1]-1].By)/2; }
    else { DzBy = (field[this.pos[0]][this.pos[1]+1].By - field[this.pos[0]][this.pos[1]-1].By)/2; }
